...
- Открытый ответ (`open`) или просто напишите ответ текстом — **LLM оценит ваш вариант по шкале 0-10**, укажет, что верно, что упущено и как ответить лучше (нужен `QWEN_API_KEY`)
