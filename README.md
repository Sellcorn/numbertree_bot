...
Длинный ответ автоматически режется на несколько сообщений: у Telegram лимит 4096
символов, и при превышении он отвергает сообщение целиком. Режем markdown **до**
конвертации в HTML (иначе рвутся теги), а размер куска подбираем по факту — разметка
раздувает текст неравномерно, сильнее всего жирный шрифт.
