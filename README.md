...
- поиск идёт до 3 кругов: модель уточняет формулировки и углубляется в детали.
...
Цена: круг — это вызов модели плюс пачка параллельных запросов к Tavily. На практике
полный ресерч занимает 25-30 секунд и расходует около 10 запросов из квоты Tavily. Поэтому поиск и отдан на усмотрение модели,
