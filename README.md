...
- поиск идёт до 3 кругов: модель может уточнить запрос и поискать снова;
...
Цена: каждый круг — вызов модели плюс запрос к Tavily, то есть ответ с поиском
занимает на 10-25 секунд дольше. Поэтому поиск и отдан на усмотрение модели,
